-- ===============================================
-- CampusWorks - Blacklisted Tokens Table Setup
-- ===============================================
-- This script creates the blacklisted_tokens table for JWT logout functionality
...
SELECT 'Blacklisted tokens table created successfully!' as Status;
